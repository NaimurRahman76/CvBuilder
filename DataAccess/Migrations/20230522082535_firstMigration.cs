        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomSections_Cvs_CvId",
                        column: x => x.CvId,
                        principalTable: "Cvs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomSectionId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedBy = table.Column<long>(type: "bigint", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomFields_CustomSections_CustomSectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasicInfos_CvId",
                table: "BasicInfos",
                column: "CvId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomFields_CustomSectionId",
                table: "CustomFields",
                column: "CustomSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomSections_CvId",
